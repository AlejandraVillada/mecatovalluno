...
<body class="container">
    ...
    <div class="card card-primary">
        <div class="card-header bg-primary text-center text-white titulo">Empleados</div>
        <div class="card-body">
            <div class="pull-right box-tools">
                <button class="btn btn-info btn-sm" id="nuevo" data-toggle="tooltip" title="Registrar Nuevo Empleado">Registrar Empleado</button>
            </div>
        </div>
